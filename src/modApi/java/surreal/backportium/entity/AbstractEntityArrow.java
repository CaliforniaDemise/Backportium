...
public abstract class AbstractEntityArrow extends EntityArrow {
    ...
    protected boolean shouldDieAfterHit(Entity entity) {
        return !(entity instanceof EntityEnderman);
    }

    protected boolean shouldHitEntity(Entity entity) {
        return true;
    }

    protected boolean shouldHitBlock(BlockPos pos, IBlockState state) {
        return true;
    }

    protected SoundEvent getEntityHitSound(Entity entity) {
        return SoundEvents.ENTITY_ARROW_HIT;
    }

    protected SoundEvent getBlockHitSound(BlockPos pos, IBlockState state) {
        return SoundEvents.ENTITY_ARROW_HIT;
    }
    ...
    protected float getHitDamage(Entity entity, float damage) {
        return damage;
    }
