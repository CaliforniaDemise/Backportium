package surreal.backportium.client.block.render;
...
import surreal.backportium.client.entity.model.ModelConduit;
import surreal.backportium._internal.tile.TileConduit;

public class TileConduitRenderer extends TileEntitySpecialRenderer<TileConduit> {
    ...
    @Override
    public void render(@NotNull TileConduit te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
