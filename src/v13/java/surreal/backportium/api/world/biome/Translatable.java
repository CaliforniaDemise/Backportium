...
import surreal.backportium._internal.core.visitor.BiomeNameVisitor;

/**
 * Expands {@link Biome} class to allow biome names to be translatable
 * See {@link BiomeNameVisitor} for more information
 */
...
public interface Translatable {
     ...
     * This method is implemented in {@link BiomeNameVisitor} actual implementation is not empty.
