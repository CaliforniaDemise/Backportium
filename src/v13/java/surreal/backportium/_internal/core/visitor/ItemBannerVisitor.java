 ...
 **/
public final class ItemBannerVisitor extends LeClassVisitor {

    private static final String HOOKS = "surreal/backportium/_internal/core/visitor/ItemBannerVisitor$Hooks";

    public ItemBannerVisitor(ClassVisitor cv) { super(cv); }
