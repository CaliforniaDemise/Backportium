                ...
                while (iterator.hasNext()) {
                    ...
                    if (node.getOpcode() == SIPUSH) {
                        InsnList list = new InsnList();
                        {
                            ...
                            list.add(new FieldInsnNode(GETSTATIC, "surreal/backportium/block/ModBlocks", "BUBBLE_COLUMN", "Lnet/minecraft/block/Block;")); /// {@link surreal.backportium.block.ModBlocks.BUBBLE_COLUMN}
